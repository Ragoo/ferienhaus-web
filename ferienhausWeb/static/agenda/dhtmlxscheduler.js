...
window.dhtmlXScheduler = window.scheduler = {version: "4.3.1"}, window.dhtmlx || (dhtmlx = function (e) {
    ...
    var r = [], d = t.evaluate(e, a, function (e) {
        return i
    }, n, null);
    ...
    setTransactionMode: function (e, t) {
        ...
        if (e) {
            ...
            if ("GET" == this._tMode) i.loadXML(s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, t)); else if ("POST" == this._tMode) i.loadXML(s, !0, this.serialize(e, t)); else if ("REST" == this._tMode) {
    ...
    if (this._drag_mode) {
        ...
        if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
            ...
            if (this._table_view || c.getDate() == u.getDate() && c.getHours() < this.config.last_hour || scheduler._allow_dnd)if (o.start_date = u,
    ...
    if (!e || 2 != e.button || !scheduler.config.touch) {
        if (this._drag_mode && this._drag_id) {
            ...
            var t = this._drag_id, i = this._drag_mode, s = !this._drag_pos || this._drag_pos.has_moved, a = this.getEvent(this._drag_id);
            if (s && (this._drag_event._dhx_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                ...
                } else this._new_event || this.callEvent(n ? "onEventAdded" : "onEventChanged", [t, this.getEvent(t)]); else n ? this.deleteEvent(a.id, !0) : (this._drag_event._dhx_changed = !1,
    ...
    date: {
        ...
        month_short: ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"],
        ...
        icon_delete: "Löschen",
        confirm_closing: "",
        confirm_deleting: "Das Ereignis wird dauerhaft gelöscht. Sicher?",
    ...
    if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view)if (t) this._colsS.heights = s; else {
        ...
        if (r.rows) {
            ...
            var f = (r.parentNode.childNodes, (a[0] + 1) * i + 1), v = f, m = f + "px";
        ...
        if (n._sday = this._get_event_sday(n), this._ignores[n._sday]) e.splice(a, 1), a--; else {
            if (i[n._sday] || (i[n._sday] = []), !t) {
                ...
                if (h.length && (h[h.length - 1]._inner = !0),
                        !g)if (h.length)if (h.length <= h[h.length - 1]._sorder) {
    ...
    for (var i, s = [], a = [[], [], [], [], [], [], []], n = this._colsS.heights, r = this._cols.length, d = {}, o = 0; o < e.length; o++) {
        ...
        if (l._sday = g % r, !this._ignores[l._sday] || !l._timed) {
            ...
            if (l._sorder && t || (l._sorder = v), l._sday + l._length <= r) i = null, s.push(l), m[v] = l, n[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk, l._last_chunk = _.last_chunk; else {
    ...
    c && (_ = _ + " " + c);
    var u = e.color ? "background:" + e.color + ";" : "", g = e.textColor ? "color:" + e.textColor + ";" : "", f = '<div event_id="' + h + '" class="' + _ + '" style="position:absolute; top:' + i + "px; left:" + t + "px; width:" + (s - 4) + "px; height:" + a + "px;" + (n || "") + '"></div>';
    ...
    if (n) {
        ...
        g && (u += " " + g);
        var f = e.color ? "background:" + e.color + ";" : "", v = e.textColor ? "color:" + e.textColor + ";" : "", m = ["position:absolute", "top:" + s + "px", "left:" + a + "px", "width:" + (n - a - 15) + "px", v, f, e._text_style || ""].join(";"), p = '<div event_id="' + e.id + '" class="' + u + '" style="' + m + '">';
    ...
    s(document.body, e[0], function (e) {
        ...
        if (!i(e)) {
            ...
            if (u = a, !_ && !h && scheduler.config.touch_drag) {
                var n = scheduler._locate_event(document.activeElement), r = scheduler._locate_event(s.target), g = d ? scheduler._locate_event(d.target) : null;
